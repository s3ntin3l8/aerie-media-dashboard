// ============================================================
// AERIE — Media command center · mock data
// ============================================================
...
const SERVICES = [
  ...
  { id: 'radarr',     name: 'Radarr',       cat: 'automation', icon: 'movie',          embeddable: true,  host: 'radarr.aerie.tv',      version: '5.14.0',  status: 'degraded', uptime: 98.40, ms: 240, beats: beat([], [24,25,26]), note: 'Slow indexer response' },
  ...
  { id: 'jellystat',  name: 'Jellystat',    cat: 'monitor',    icon: 'insights',       embeddable: true,  host: 'jellystat.aerie.tv',   version: '1.1.4',   status: 'up',       uptime: 99.80, ms: 63,  beats: beat(),            note: 'Jellyfin stats' },
  ...
  { id: 'qbittorrent',name: 'qBittorrent',  cat: 'automation', icon: 'downloading',    embeddable: true,  host: 'qbit.aerie.tv',        version: '4.6.5',   status: 'up',       uptime: 99.60, ms: 58,  beats: beat([5]),         note: 'Download client' },
...
// Now-playing streams (Plex + Jellyfin), normalized
const NOW_PLAYING = [
...
// Overseerr requests — current user (you) + others (admin queue)
const REQUESTS = [
...
const PLAYS_24H = [2,1,0,0,1,3,4,2,1,2,5,6,4,3,2,4,7,9,8,6,9,7,5,3];

// Recently added (restrained poster placeholders)
const RECENT = [
...
// Download queue (arr) for admin/status
const QUEUE = [
